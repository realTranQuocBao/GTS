...
int main(){
	...
	BORROW_RETURN *borrowReturnRecords = new BORROW_RETURN[100];	//Khoi tao So ghi Phieu muon tra, 10000 record
	BOOK *books = new BOOK[500];									//Khoi tao mang 10000 ddaauf sachs, sao cho nay bi tran Data :(
